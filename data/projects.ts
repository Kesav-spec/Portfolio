export const projects: Project[] = [
	{
		...
		description: [
			"Built a comprehensive web platform for anime and manga enthusiasts, delivering information on over 22,000 anime and 60,000 manga titles, including TV series, movies, OVAs, manga, manhwa, novels, and more.",
			...
			"Optimized the platform's performance, achieving high scores on Lighthouse tests for accessibility, performance, SEO, and best practices.",
		],
	},
	{
		type: "Personal Project",
